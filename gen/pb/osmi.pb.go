...
type CustomerFilter struct {
	...
	IsActive        *wrapperspb.BoolValue  `protobuf:"bytes,9,opt,name=is_active,json=isActive,proto3" json:"is_active,omitempty"` // ← CAMBIADO
	IsVip           *wrapperspb.BoolValue  `protobuf:"bytes,10,opt,name=is_vip,json=isVip,proto3" json:"is_vip,omitempty"`         // ← CAMBIADO
...
func (x *CustomerFilter) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *CustomerFilter) GetTaxId() string {
	if x != nil {
		return x.TaxId
	}
	return ""
...
func (x *CustomerFilter) GetPublicId() string {
	if x != nil {
		return x.PublicId
	}
	return ""
...
func (x *CustomerFilter) GetCompanyName() string {
	if x != nil {
		return x.CompanyName
	}
	return ""
...
func (x *CustomerFilter) GetCountry() string {
	if x != nil {
		return x.Country
	}
	return ""
...
func (x *CustomerFilter) GetCustomerSegment() string {
	if x != nil {
...
func (x *CustomerFilter) GetIsActive() *wrapperspb.BoolValue {
	if x != nil {
		return x.IsActive
	}
	return nil
...
func (x *CustomerFilter) GetIsVip() *wrapperspb.BoolValue {
	if x != nil {
		return x.IsVip
	}
	return nil
...
func (x *CustomerFilter) GetDateFrom() string {
	if x != nil {
		return x.DateFrom
	}
	return ""
...
func (x *CustomerFilter) GetDateTo() string {
	if x != nil {
		return x.DateTo
	}
	return ""
...
const file_osmi_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"osmi.proto\x12\x04osmi\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\a\n" +
	"\x05Empty\"\x9d\x01\n" +
	...
	"\r_company_nameB\t\n" +
	"\a_is_vipB\x10\n" +
	"\x0e_customer_typeJ\x05\bd\x10\xc8\x01\"\x92\x03\n" +
	"\x0eCustomerFilter\x12\x16\n" +
	...
	"\fcompany_name\x18\x06 \x01(\tR\vcompanyName\x12\x18\n" +
	"\acountry\x18\a \x01(\tR\acountry\x12)\n" +
	"\x10customer_segment\x18\b \x01(\tR\x0fcustomerSegment\x127\n" +
	"\tis_active\x18\t \x01(\v2\x1a.google.protobuf.BoolValueR\bisActive\x121\n" +
	"\x06is_vip\x18\n" +
	" \x01(\v2\x1a.google.protobuf.BoolValueR\x05isVip\x12\x1b\n" +
	"\tdate_from\x18\v \x01(\tR\bdateFrom\x12\x17\n" +
	"\adate_to\x18\f \x01(\tR\x06dateTo\"u\n" +
	"\x14ListCustomersRequest\x12,\n" +
	"\x06filter\x18\x01 \x01(\v2\x14.osmi.CustomerFilterR\x06filter\x12\x12\n" +
